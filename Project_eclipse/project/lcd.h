...
#define LCD_RS_PORT_ID PORTB_ID     /* Macro definition the port number in which RS  is connected to*/


#define LCD_READ_WRITE_PIN PIN1_ID   /* Macro definition the pin number in which RW' is connected to */
#define LCD_READ_WRITE_PORT_ID PORTB_ID  /* Macro definition the port number in which RW' is connected to */

#define LCD_ENABLE PIN2_ID             /*Macro definition the pin number in which Enable is connected to*/
#define LCD_ENABLE_PORT_ID PORTB_ID   /*Macro definition the port number in which Enable is connected to*/
